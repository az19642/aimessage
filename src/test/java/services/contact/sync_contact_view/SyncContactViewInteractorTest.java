...
public class SyncContactViewInteractorTest {
    ...
    void successTest() {
        ...
        Message message = messageFactory.create("Hello, this is User!", "User", LocalDateTime.now());

        Contact contact = contactFactory.create("Contact1", "EN", LocalDateTime.now(), List.of(message));

        User user = commonUserFactory.create("User", "Password", "EN", LocalDateTime.now(), List.of(contact));
        ...
        SyncContactViewOutputBoundary loadContactsToViewPresenter = new SyncContactViewOutputBoundary() {
            ...
            public void prepareSuccessView(SyncContactViewOutputData loadContactsToViewOutputData) {
                assert loadContactsToViewOutputData.getContactToLastMessage().get("Contact1").equals(
                        "Hello, this is " + "User!");
        ...
        SyncContactViewInteractor syncContactViewInteractor = new SyncContactViewInteractor(loadContactsToViewPresenter,
