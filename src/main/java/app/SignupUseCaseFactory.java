...
import features.auth.password_generation.interface_adapters.PasswordGeneratorController;
import features.auth.password_generation.interface_adapters.PasswordGeneratorPresenter;
import features.auth.password_generation.interface_adapters.PasswordGeneratorViewModel;
import features.auth.signup.interface_adapters.SignupController;
import features.auth.signup.interface_adapters.SignupPresenter;
...
import features.auth.password_generation.PasswordGeneratorInteractor;
import features.auth.password_generation.PasswordGeneratorOutputBoundary;
import features.auth.password_generation.PasswordGeneratorUserDataAccessInterface;
import features.auth.signup.SignupInputBoundary;
import features.auth.signup.SignupInteractor;
import features.auth.signup.SignupOutputBoundary;
import features.auth.signup.SignupUserDataAccessInterface;
