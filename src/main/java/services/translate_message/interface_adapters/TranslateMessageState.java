 ...
 */
public class TranslateMessageState {
     ...
     */
    public TranslateMessageState(TranslateMessageState copy) {
    ...
    public String toString() {
        return "textToSpeechState{" + "textToSpeechError='" + translatorError + '\'' + '}';
    }
}
